...
pub const VERSIONED_JSON_CONTRACTS: &[JsonContractDescriptor] = &[
    JsonContractDescriptor { schema: OVERVIEW_SCHEMA_V1, rust_type: "RepositoryOverview" },
    JsonContractDescriptor { schema: SEARCH_SCHEMA_V1, rust_type: "SearchReport" },
    JsonContractDescriptor { schema: ENTITY_EXPLANATION_SCHEMA_V1, rust_type: "EntityExplanation" },
    JsonContractDescriptor { schema: IMPACT_ANALYSIS_SCHEMA_V1, rust_type: "ImpactAnalysis" },
    JsonContractDescriptor { schema: DIAGNOSTIC_CHECK_SCHEMA_V1, rust_type: "DiagnosticCheckReport" },
    JsonContractDescriptor { schema: AFFECTED_CHECK_SCHEMA_V1, rust_type: "AffectedCheckReport" },
    JsonContractDescriptor { schema: OPERATIONS_DOCS_CHECK_SCHEMA_V1, rust_type: "OperationsDocsCheckReport" },
    JsonContractDescriptor { schema: COVERAGE_SCHEMA_V1, rust_type: "CoverageReport" },
    JsonContractDescriptor { schema: CAPABILITIES_SCHEMA_V1, rust_type: "CapabilitiesReport" },
    JsonContractDescriptor { schema: CHANGE_MAP_SCHEMA_V1, rust_type: "ChangeMapReport" },
    JsonContractDescriptor { schema: CONTEXT_PACK_SCHEMA_V1, rust_type: "ContextReport" },
    JsonContractDescriptor { schema: GRAPH_EXPORT_SCHEMA_V1, rust_type: "GraphExport" },
    JsonContractDescriptor { schema: GRAPH_RELATED_SCHEMA_V1, rust_type: "GraphRelated" },
    JsonContractDescriptor { schema: GRAPH_PATH_SCHEMA_V1, rust_type: "GraphPath" },
    JsonContractDescriptor { schema: GRAPH_HUBS_SCHEMA_V1, rust_type: "GraphHubs" },
    JsonContractDescriptor { schema: GRAPH_PAGERANK_SCHEMA_V1, rust_type: "GraphPageRank" },
    JsonContractDescriptor { schema: GRAPH_CYCLES_SCHEMA_V1, rust_type: "GraphCycles" },
    JsonContractDescriptor { schema: RUSTOK_FFA_AUDIT_SCHEMA_V1, rust_type: "RustokFfaAudit" },
    JsonContractDescriptor { schema: RUSTOK_FFA_SURFACE_GRAPH_SCHEMA_V1, rust_type: "RustokFfaSurfaceGraphReport" },
    JsonContractDescriptor { schema: RUSTOK_FFA_VIOLATIONS_GRAPH_SCHEMA_V1, rust_type: "RustokFfaViolationsGraphReport" },
    JsonContractDescriptor { schema: RUSTOK_FBA_AUDIT_SCHEMA_V1, rust_type: "RustokFbaAudit" },
    JsonContractDescriptor { schema: RUSTOK_FBA_MODULE_GRAPH_SCHEMA_V1, rust_type: "RustokFbaModuleGraphReport" },
    JsonContractDescriptor { schema: RUSTOK_FBA_PORT_GRAPH_SCHEMA_V1, rust_type: "RustokFbaPortGraphReport" },
    JsonContractDescriptor { schema: RUSTOK_FBA_DEPENDENCIES_GRAPH_SCHEMA_V1, rust_type: "RustokFbaDependenciesGraphReport" },
    JsonContractDescriptor { schema: RUSTOK_FBA_VIOLATIONS_GRAPH_SCHEMA_V1, rust_type: "RustokFbaViolationsGraphReport" },
    JsonContractDescriptor { schema: RUSTOK_PAGE_BUILDER_AUDIT_SCHEMA_V1, rust_type: "RustokPageBuilderAudit" },
    JsonContractDescriptor { schema: RUSTOK_PAGE_BUILDER_PROVIDER_GRAPH_SCHEMA_V1, rust_type: "RustokPageBuilderProviderGraphReport" },
    JsonContractDescriptor { schema: RUSTOK_PAGE_BUILDER_CONSUMER_GRAPH_SCHEMA_V1, rust_type: "RustokPageBuilderConsumerGraphReport" },
    JsonContractDescriptor { schema: RUSTOK_PAGE_BUILDER_VIOLATIONS_GRAPH_SCHEMA_V1, rust_type: "RustokPageBuilderViolationsGraphReport" },
    JsonContractDescriptor { schema: PROJECT_REGISTRY_REPORT_SCHEMA_V1, rust_type: "ProjectRegistryReport" },
    JsonContractDescriptor { schema: PROJECT_RESOLUTION_SCHEMA_V1, rust_type: "ProjectResolutionReport" },
];
...
macro_rules! impl_owned_schema_contract {
    ($type:path, $schema:ident) => {
        impl VersionedJsonContract for $type {
            ...
            fn schema(&self) -> &str { &self.schema }
        }
    };
}
...
impl_owned_schema_contract!(crate::check::OperationsDocsCheckReport, OPERATIONS_DOCS_CHECK_SCHEMA_V1);
...
impl_owned_schema_contract!(crate::rustok_json_contract::RustokFfaSurfaceGraphReport, RUSTOK_FFA_SURFACE_GRAPH_SCHEMA_V1);
impl_owned_schema_contract!(crate::rustok_json_contract::RustokFfaViolationsGraphReport, RUSTOK_FFA_VIOLATIONS_GRAPH_SCHEMA_V1);
impl_owned_schema_contract!(crate::graph::RustokFbaAudit, RUSTOK_FBA_AUDIT_SCHEMA_V1);
impl_owned_schema_contract!(crate::rustok_json_contract::RustokFbaModuleGraphReport, RUSTOK_FBA_MODULE_GRAPH_SCHEMA_V1);
impl_owned_schema_contract!(crate::rustok_json_contract::RustokFbaPortGraphReport, RUSTOK_FBA_PORT_GRAPH_SCHEMA_V1);
impl_owned_schema_contract!(crate::rustok_json_contract::RustokFbaDependenciesGraphReport, RUSTOK_FBA_DEPENDENCIES_GRAPH_SCHEMA_V1);
impl_owned_schema_contract!(crate::rustok_json_contract::RustokFbaViolationsGraphReport, RUSTOK_FBA_VIOLATIONS_GRAPH_SCHEMA_V1);
impl_owned_schema_contract!(crate::graph::RustokPageBuilderAudit, RUSTOK_PAGE_BUILDER_AUDIT_SCHEMA_V1);
impl_owned_schema_contract!(crate::rustok_json_contract::RustokPageBuilderProviderGraphReport, RUSTOK_PAGE_BUILDER_PROVIDER_GRAPH_SCHEMA_V1);
impl_owned_schema_contract!(crate::rustok_json_contract::RustokPageBuilderConsumerGraphReport, RUSTOK_PAGE_BUILDER_CONSUMER_GRAPH_SCHEMA_V1);
impl_owned_schema_contract!(crate::rustok_json_contract::RustokPageBuilderViolationsGraphReport, RUSTOK_PAGE_BUILDER_VIOLATIONS_GRAPH_SCHEMA_V1);
impl_owned_schema_contract!(crate::project_registry::ProjectRegistryReport, PROJECT_REGISTRY_REPORT_SCHEMA_V1);
impl_owned_schema_contract!(crate::project_registry::ProjectResolutionReport, PROJECT_RESOLUTION_SCHEMA_V1);
...
pub fn validate_schema_id(schema: &str) -> Result<u32, JsonContractError> {
    ...
    if segments.len() < 3 || segments.first() != Some(&"athanor") {
        return Err(JsonContractError::InvalidSchemaId { schema: schema.to_string(), reason: "expected athanor.<name>.v<major>" });
    }
    let (version, names) = segments.split_last().expect("schema segment count was checked above");
    if names[1..].iter().any(|segment| {
        segment.is_empty() || !segment.chars().all(|character| {
            character.is_ascii_lowercase() || character.is_ascii_digit() || matches!(character, '_' | '-')
        })
    }) {
        return Err(JsonContractError::InvalidSchemaId { schema: schema.to_string(), reason: "name segments must use lowercase ASCII, digits, '_' or '-'" });
    }
    let major = version
        .strip_prefix('v')
        ...
        .ok_or_else(|| JsonContractError::InvalidSchemaId { schema: schema.to_string(), reason: "version must be a positive decimal major prefixed with 'v'" })?;
    Ok(major)
}

/// Validates that every registered schema and Rust owner is unique.
pub fn validate_contract_registry(contracts: &[JsonContractDescriptor]) -> Result<(), JsonContractError> {
    let mut schemas = BTreeSet::new();
    let mut rust_types = BTreeSet::new();
    for contract in contracts {
        validate_schema_id(contract.schema)?;
        if !schemas.insert(contract.schema) {
            return Err(JsonContractError::DuplicateSchemaId { schema: contract.schema.to_string() });
        }
        if !rust_types.insert(contract.rust_type) {
            return Err(JsonContractError::DuplicateRustTypeOwner { rust_type: contract.rust_type.to_string() });
        }
    }
    Ok(())
}
...
pub fn validate_contract_value(expected_schema: &str, value: &Value) -> Result<(), JsonContractError> {
    validate_schema_id(expected_schema)?;
    let object = value.as_object().ok_or(JsonContractError::TopLevelDocumentRequired)?;
    let actual = object.get("schema").ok_or(JsonContractError::MissingSchemaField)?.as_str().ok_or(JsonContractError::NonStringSchemaField)?;
    if actual != expected_schema {
        return Err(JsonContractError::SchemaMismatch { expected: expected_schema.to_string(), actual: actual.to_string() });
    }
    Ok(())
}
...
pub enum JsonContractError {
    InvalidSchemaId { schema: String, reason: &'static str },
    DuplicateSchemaId { schema: String },
    DuplicateRustTypeOwner { rust_type: String },
...
impl fmt::Display for JsonContractError {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Self::InvalidSchemaId { schema, reason } => write!(formatter, "invalid JSON contract schema `{schema}`: {reason}"),
            Self::DuplicateSchemaId { schema } => write!(formatter, "duplicate JSON contract schema owner for `{schema}`"),
            Self::DuplicateRustTypeOwner { rust_type } => write!(formatter, "duplicate JSON contract Rust type owner `{rust_type}`"),
            Self::TopLevelDocumentRequired => formatter.write_str("versioned JSON contract must serialize as an object"),
            Self::MissingSchemaField => formatter.write_str("versioned JSON contract is missing top-level `schema`"),
            Self::NonStringSchemaField => formatter.write_str("versioned JSON contract `schema` must be a string"),
            Self::SchemaMismatch { expected, actual } => write!(formatter, "versioned JSON contract schema mismatch: expected `{expected}`, got `{actual}`"),
            Self::Serialization(message) => write!(formatter, "failed to serialize versioned JSON contract: {message}"),
        }
    }
}
...
mod tests {
    ...
    #[derive(Serialize)]
    struct ExampleContract { schema: String, value: u32 }
    ...
    fn rejects_unversioned_or_noncanonical_schema_ids() {
        for schema in ["search.v1", "athanor.search", "athanor.Search.v1", "athanor.search.v0", "athanor.search.vx", "athanor..v1"] {
    ...
    fn validates_serialized_schema_field() {
        let contract = ExampleContract { schema: ExampleContract::SCHEMA.to_string(), value: 7 };
        assert_eq!(contract.validate_contract(), Ok(()));
    }

    #[test]
    fn rejects_instance_and_serialized_schema_mismatches() {
        let contract = ExampleContract { schema: "athanor.example_contract.v1".to_string(), value: 7 };
        assert_eq!(contract.validate_contract(), Err(JsonContractError::SchemaMismatch { expected: "athanor.example_contract.v2".to_string(), actual: "athanor.example_contract.v1".to_string() }));
        assert_eq!(validate_contract_value(ExampleContract::SCHEMA, &json!({ "value": 7 })), Err(JsonContractError::MissingSchemaField));
    }
    ...
    fn registry_contains_unique_valid_schema_and_type_owners() {
        ...
        assert_eq!(crate::capabilities::CAPABILITIES_REPORT_SCHEMA, CAPABILITIES_SCHEMA_V1);
        ...
        assert_eq!(crate::graph::RUSTOK_FFA_SURFACE_GRAPH_SCHEMA, RUSTOK_FFA_SURFACE_GRAPH_SCHEMA_V1);
        assert_eq!(crate::graph::RUSTOK_FFA_VIOLATIONS_GRAPH_SCHEMA, RUSTOK_FFA_VIOLATIONS_GRAPH_SCHEMA_V1);
        assert_eq!(crate::graph::RUSTOK_FBA_AUDIT_SCHEMA, RUSTOK_FBA_AUDIT_SCHEMA_V1);
        assert_eq!(crate::graph::RUSTOK_FBA_MODULE_GRAPH_SCHEMA, RUSTOK_FBA_MODULE_GRAPH_SCHEMA_V1);
        assert_eq!(crate::graph::RUSTOK_FBA_PORT_GRAPH_SCHEMA, RUSTOK_FBA_PORT_GRAPH_SCHEMA_V1);
        assert_eq!(crate::graph::RUSTOK_FBA_DEPENDENCIES_GRAPH_SCHEMA, RUSTOK_FBA_DEPENDENCIES_GRAPH_SCHEMA_V1);
        assert_eq!(crate::graph::RUSTOK_FBA_VIOLATIONS_GRAPH_SCHEMA, RUSTOK_FBA_VIOLATIONS_GRAPH_SCHEMA_V1);
        assert_eq!(crate::graph::RUSTOK_PAGE_BUILDER_AUDIT_SCHEMA, RUSTOK_PAGE_BUILDER_AUDIT_SCHEMA_V1);
        assert_eq!(crate::graph::RUSTOK_PAGE_BUILDER_PROVIDER_GRAPH_SCHEMA, RUSTOK_PAGE_BUILDER_PROVIDER_GRAPH_SCHEMA_V1);
        assert_eq!(crate::graph::RUSTOK_PAGE_BUILDER_CONSUMER_GRAPH_SCHEMA, RUSTOK_PAGE_BUILDER_CONSUMER_GRAPH_SCHEMA_V1);
        assert_eq!(crate::graph::RUSTOK_PAGE_BUILDER_VIOLATIONS_GRAPH_SCHEMA, RUSTOK_PAGE_BUILDER_VIOLATIONS_GRAPH_SCHEMA_V1);
        assert_eq!(crate::project_registry::PROJECT_REGISTRY_REPORT_SCHEMA, PROJECT_REGISTRY_REPORT_SCHEMA_V1);
        assert_eq!(crate::project_registry::PROJECT_RESOLUTION_SCHEMA, PROJECT_RESOLUTION_SCHEMA_V1);
    }

    #[test]
    fn registry_rejects_duplicate_schema_and_type_owners() {
        let duplicate_schema = [
            JsonContractDescriptor { schema: "athanor.example.v1", rust_type: "ExampleV1" },
            JsonContractDescriptor { schema: "athanor.example.v1", rust_type: "ExampleAlias" },
        ];
        assert_eq!(validate_contract_registry(&duplicate_schema), Err(JsonContractError::DuplicateSchemaId { schema: "athanor.example.v1".to_string() }));
        let duplicate_type = [
            JsonContractDescriptor { schema: "athanor.example.v1", rust_type: "Example" },
            JsonContractDescriptor { schema: "athanor.example.v2", rust_type: "Example" },
        ];
        assert_eq!(validate_contract_registry(&duplicate_type), Err(JsonContractError::DuplicateRustTypeOwner { rust_type: "Example".to_string() }));
    }
}
