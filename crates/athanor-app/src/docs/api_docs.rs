...
pub(super) const COORDINATION_START_PREFIX: &str =
    "<!-- athanor:api-docs-coordination:start ";
pub(super) const COORDINATION_END: &str = "<!-- athanor:api-docs-coordination:end -->";
pub(super) const NARRATIVE_REVIEW_START: &str =
    "<!-- athanor:api-narrative-review:start -->";
pub(super) const NARRATIVE_REVIEW_END: &str =
    "<!-- athanor:api-narrative-review:end -->";
