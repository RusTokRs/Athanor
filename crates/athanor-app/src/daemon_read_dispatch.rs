...
/// Routes read-only commands through operation-aware query paths and delegates control/write
/// commands to the bounded command dispatcher.
pub(crate) async fn execute(
    ...
    {
        return crate::daemon_command_dispatch::execute(state, request).await;
    }
