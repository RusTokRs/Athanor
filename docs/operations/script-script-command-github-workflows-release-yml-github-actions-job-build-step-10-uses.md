---
entities:
- script-command://.github/workflows/release.yml#github-actions:job:build:step:10:uses
...
status: verified
---
# Script Command `GitHub Actions uses step build step 10`
...
- Canonical entity: `script-command://.github/workflows/release.yml#github-actions:job:build:step:10:uses`
- Entity kind: `script_command`
- Source: `.github/workflows/release.yml`:10
...
Generated from diagnostic `diag_script_ba6b556d89bde1a5`. Review this page before relying on it as operational documentation.
