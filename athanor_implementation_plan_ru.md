...
| `DS-JSON-002` | P1 | `[-] in progress` | Создан registry-wide inventory; остаются process protocols, persistence и specialized Rustok families |
...
- [ ] Добавить enforcement, запрещающий незарегистрированные agent-facing schema literals.
...
**Сейчас:** `DS-JSON-001/002` — 17 уникальных public contracts зарегистрированы; inventory создан; verification и compatibility blockers остаются.
